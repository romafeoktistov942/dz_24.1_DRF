...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.course = Course.objects.create(course_name="Курс", owner=self.user)
        self.lesson = Lesson.objects.create(
            lesson_name="Урок", course=self.course, owner=self.user
        )
    ...
    def test_lesson_create(self):
        ...
        data = {"lesson_name": "Тест", "video": "youtube.com"}
